...
public class DocTypeController {
    ...
    @PostMapping
    public ResponseEntity<?> createDocType(
            @Valid @RequestBody DocTypeRequest request,
            HttpSession session) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> updateDocType(
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteDocType(@PathVariable Long id, HttpSession session) {
        sessionService.validateTeamLeader(session);
